...
class User(Document):
    ...
    role = ReferenceField(Role, default=2)
    country = ReferenceField(Country, default=0)
    # university = ReferenceField(University)
    department = ReferenceField(Department, department=0)
    chair = ReferenceField(Chair,  department=0)
